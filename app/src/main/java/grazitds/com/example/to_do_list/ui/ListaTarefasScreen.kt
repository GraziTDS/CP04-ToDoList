...
private fun ConfirmarExclusaoDialog(
    ...
    AlertDialog(
        ...
        text = {
            Text("Tem certeza que deseja excluir a tarefa \"${tarefa.titulo}\"? Essa ação não pode ser desfeita.")
        },
        confirmButton = {
...
@Preview(showBackground = true, name = "Confirmar exclusão de tarefa")
@Composable
